...
export default function SignUpWithPayment() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-8">
        ...
        <Card className="relative overflow-hidden bg-white/90 backdrop-blur-sm border-white/20 shadow-xl">
          ...
          <CardHeader className="relative text-center pb-6">
            <CardTitle className="text-2xl font-bold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">
              Suscríbete a Estrella
            </CardTitle>
            <CardDescription className="text-slate-600">
              Accede a todo el contenido por solo 22 €/mes
            </CardDescription>
          </CardHeader>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-green-700">
                      Plan mensual activado. Completa tu registro abajo.
                    </p>
                  </div>
                </div>
              </motion.div>
      ...
      {/* Script de PayPal solo para plan mensual */}
      <Script
            ...
            .Buttons({
              ...
              createSubscription: function (data, actions) {
                return actions.subscription.create({
                  plan_id: "P-7PF96689L4734453RNBSUC2I", // tu ID de plan mensual
                });
              },
