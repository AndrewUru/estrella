...
export default function BienvenidaPage() {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-900 to-indigo-900 text-white p-8 text-center">
        <h1 className="text-3xl font-bold mb-4">✨ Bienvenida a Estrella del Alba 7D ✨</h1>
        <p className="text-lg mb-6 max-w-xl">
          Tu camino de reconexión contigo misma comienza aquí. Disfruta de los contenidos
          y experiencias diseñados para activar tu luz interior.
        </p>
        <a
          href="/protected"
