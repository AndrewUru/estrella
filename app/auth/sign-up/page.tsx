  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-20 left-20 w-32 h-32 border border-violet-200/30 dark:border-violet-700/30 rounded-full animate-spin" style={{ animationDuration: "20s" }} />
        <div className="absolute bottom-20 right-20 w-24 h-24 border border-purple-200/30 dark:border-purple-700/30 rounded-full animate-spin" style={{ animationDuration: "25s", animationDirection: "reverse" }} />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-24">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl lg:text-5xl font-bold bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 dark:from-violet-400 dark:via-purple-400 dark:to-indigo-400 bg-clip-text text-transparent leading-tight">
            ...
            {/* Beneficios */}
            <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/30 dark:border-gray-700/30">
              ...
              <ul className="space-y-3 text-sm text-slate-700 dark:text-slate-300">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-violet-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Claridad energética restaurada</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-violet-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Canal intuitivo activo</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-violet-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Dirección interior activada</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-violet-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Pacto sagrado con tu alma</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-r from-violet-500/10 to-purple-500/10 dark:from-violet-600/20 dark:to-purple-600/20 rounded-2xl p-6 border border-violet-200/30 dark:border-violet-700/30">
              <div className="text-center lg:text-left">
                <p className="text-lg text-slate-700 dark:text-slate-300 font-semibold mb-2">
                  Todo esto por solo{" "}
