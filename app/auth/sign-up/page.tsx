        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 items-start">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/30 dark:border-gray-700/30">
              ...
              <ul className="space-y-3 text-sm xl:text-base text-slate-700 dark:text-slate-300">
            ...
            <div className="bg-gradient-to-r from-violet-500/10 to-purple-500/10 dark:from-violet-600/20 dark:to-purple-600/20 rounded-2xl p-6 border border-violet-200/30 dark:border-violet-700/30">
              <div className="text-center lg:text-left">
                ...
                <p className="text-sm xl:text-base text-slate-600 dark:text-slate-400 mb-4">
